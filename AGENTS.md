...
- simple is better:
    keep things as simple as possible. we can always iterate later. if you can't explain how something works to a 12 year old, it is probably too complicated. simpler also means less moving parts and smaller attack surface.
- keep files small:
