  ...
  return (
    <>
      ...
      <main style={{ maxWidth: '900px', margin: '0 auto', padding: '24px' }}>
        ...
        {!wallet.publicKey ? (
          <div style={{
            padding: '60px', textAlign: 'center', color: 'var(--muted)', fontSize: '14px',
          ...
          <div style={{
            ...
            {/* Rows */}
            {positions
              .filter((p) => !search || p.pool.tokenMint.toLowerCase().includes(search.toLowerCase()))
              .map((pos) => (
              <Link
              ...
              >
                ...
                <div style={{ textAlign: 'right', flexShrink: 0 }}>
                  ...
                  <div className="font-mono" style={{ fontSize: '11px', color: 'var(--accent)', marginTop: '2px' }}>
